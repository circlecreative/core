@extends('layouts.app')
@section('content')
<form id="form-post" class="container-fluid" action="{{ route('system.taxonomies.update',['taxonomy'=>$taxonomy->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            ...
                            <div class="nk-block-des text-soft text-sm">
                                <ul class="list-inline">
                                    <li class="text-muted">
                                        <small>ID: <span class="font-weight-bold">{{$taxonomy->id ?? null}}</span></small>
                                        <input type="hidden" name="id" value="40">
                                    </li>
                                    <li class="text-muted">
                                        <small>Last Update: <span class="font-weight-bold">{{$taxonomy->updated_at ?? null}}</span></small>
                                    </li>
                                </ul>
                            </div>
                        </div> 
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="input-name" value="{{$taxonomy->name ?? null}}" name="name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="input-slug" value="{{$taxonomy->slug ?? null}}" name="slug">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="input-code" value="{{$taxonomy->code ?? null}}" name="code">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="input-description">@lang('lang.description')</label>
                                            <div class="form-control-wrap">
                                                <textarea name="description" class="form-control" id="input-description" cols="30" rows="10">{{$taxonomy->description ?? null}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
