    ...
    <div class="nk-data data-list data-list-s2 mt-n4">
        ...
        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
            <div class="data-col">
                ...
                <span class="data-value @if(empty(auth()->user()->phone)) text-soft @endif">{{ auth()->user()->phone ?? __('Not add yet') }}</span>
            </div>
            <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
        </div>
        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
            <div class="data-col">
                ...
                <span class="data-value @if(empty(__('profile_telegram'))) text-soft @endif">{{ __('profile_telegram') ?? __('Not add yet') }}</span>
            </div>
            <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
        </div>
        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
            <div class="data-col">
                ...
                <span class="data-value">{{ !empty(__('profile_dob')) ? __('profile_dob') : __('Not add yet') }}</span>
            </div>
            <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
        </div>
        <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
            <div class="data-col">
                ...
                <span class="data-value">
                                @if (!empty(__('profile_address_line_1')))
                        {{ __('profile_address_line_1').',' }}
                    @endif

                    @if (!empty(__('profile_address_line_2')))
                        <br>{{ __('profile_address_line_2') }}
                    @endif

                    @if (!empty(__('profile_state')))
                        <br>{{ __('profile_state') }}
                    @endif

                    @if (!empty(__('profile_country')))
                        <br>{{ trans(__('profile_country')) }}
                    @endif
                            </span>
            </div>
            <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
