    ...
    <div class="card-inner-group mt-n3">
        <div class="card-inner px-0">
            <div class="between-center flex-wrap flex-md-nowrap g-3">
                <div class="nk-block-text">
                    ...
                    <p>{!! __('Save your all :link including unusual activity detected.', ['link' => '<a href="'.route('profile.view', ['activity']).'" class="link link-primary">'.__('activity logs').'</a>']) !!}</p>
                </div>
                <div class="nk-block-actions">
                    <ul class="align-center gx-3">
                        <li class="order-md-last">
                            <div class="custom-control custom-switch mr-n2">
                                <input type="checkbox" name="activity_log" class="custom-control-input quick-update-profile"{{ (( 'setting_activity_log' =="on") ? ' checked' : '') }} id="activity-log" data-key="setting">
            ...
            <div class="between-center flex-wrap flex-md-nowrap g-3">
                ...
                <div class="nk-block-actions">
                    <ul class="align-center gx-3">
                        <li class="order-md-last">
                            <div class="custom-control custom-switch mr-n2">
                                <input type="checkbox" name="unusual_activity"{{ (('setting_unusual_activity' =="on") ? ' checked' : '') }} class="custom-control-input quick-update-profile" id="unusual-activity" data-key="setting">
        ...
        <div class="card-inner px-0">
            <div class="between-center flex-wrap flex-md-nowrap g-3">
                ...
                <div class="nk-block-actions">
                    <div class="nk-block-actions">
                        @if(config('user_new_email', false))
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="{{ route('profile.settings.change.email') }}" method="POST" class="form-validate is-alter mt-4 form-authentic" id="change-email-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="email" autocomplete="new-email" name="user_new_email" value="{{ 'user_new_email' }}" class="form-control form-control-lg" id="new-email-address" placeholder="{{ __('Enter Email Address') }}" required maxlength="190">
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <ul class="align-center flex-wrap flex-sm-nowrap g-2">
                        <li>
                            <button class="btn btn-primary email-rq-verify" data-action="resend" data-url="{{ route('profile.settings.change.email.resend') }}">{{ __('Resend Email') }}</button>
                        </li>
                        <li>
                            <button class="btn btn-dim btn-danger email-rq-verify" data-action="cancel" data-url="{{ route('profile.settings.change.email.cancel') }}">{{ __('Cancel Request') }}</button>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="{{ route('profile.settings.change.password') }}" method="POST" class="form-validate is-alter mt-4 form-authentic" id="change-password-form">
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="{{ route('profile.settings.2fa', 'disable') }}" method="POST" class="form-validate is-alter mt-3">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="{{ route('profile.settings.2fa', 'enable') }}" method="POST" class="form-validate is-alter mt-3" autocomplete="off">
                        ...
                        <div class="row align-center">
                            <div class="col-sm-8">
                                ...
                                <p class="mb-1">{{ __("Account Name:") }}<br><strong class="text-dark">{{ config('global.site_name') }}</strong></p>
                                <p class="mb-1">{{ __("Your Key:") }}<br><strong class="text-dark">{{ $secret2fa }}</strong></p>
                            </div>
                            <div class="col-sm-4">
                                <div class="qr-media my-1 ml-sm-auto w-max-120px">
                                    {!! \Neo\Libraries\NeoQR::generate($qrcode2fa, 200) !!}
                                </div>
                            </div>
                        </div>
                        <div class="divider stretched sm"></div>
...
<script type="text/javascript">
    const profileSetting = "{{ route('profile.settings.save') }}";
</script>
@endpush
