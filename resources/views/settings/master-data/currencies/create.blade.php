...
@section('content')
<form id="form-post" class="nk-content-inner" action="{{ route('system.settings.master-data.tm-currencies.store') }}" method="post">
@csrf
        ...
        <div class="card-inner">
            ...
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control w-50" id="input-iso-code" value="" name="iso_code">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control w-25" id="input-symbol" value="" name="symbol">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-3 align-center">
                <div class="col-lg-5">
                    <div class="form-group">
                        <label class="form-label" for="input-code">@lang('lang.symbol_position')</label>
                    </div>
                </div>
                <div class="col-lg-7">
                    <ul class="custom-control-group g-3 align-center flex-wrap">
                        <li>
                            <div class="custom-control custom-control-sm custom-radio">
                                <input type="radio" class="custom-control-input" name="symbol_first" id="symbol-left" value="1">
                                <label class="custom-control-label" for="symbol-left">@lang('lang.left')</label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-control custom-control-sm custom-radio">
                                <input type="radio" class="custom-control-input" name="symbol_first" id="symbol-right" value="0">
