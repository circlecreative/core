...
@section('content')
<form id="form-post" class="nk-content-inner" action="{{ route('system.settings.master-data.tm-languages.update',['tm_language'=>$language->id]) }}" method="post">
@csrf
@method('PUT')
        ...
        <div class="nk-block-head-content">
            ...
            <nav>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('system.settings.master-data.tm-languages.index') }}">@lang('lang.languages')</a>
                    </li>
            ...
            <div class="nk-block-des text-soft text-sm">
                <ul class="list-inline">
                    <li class="text-muted">
                        <small>ID: <span class="font-weight-bold">{{$language->id ?? null}}</span></small>
                        <input type="hidden" name="id" value="40">
                    </li>
                    <li class="text-muted">
                        <small>Last Update: <span class="font-weight-bold">{{$language->updated_at ?? null}}</span></small>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card-inner">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control w-50" id="input-code" value="{{$language->code ?? null}}" name="code">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="input-name" value="{{$language->name ?? null}}" name="name">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="input-native" value="{{$language->native ?? null}}" name="native">
                        </div>
                    </div>
                </div>
            </div>
