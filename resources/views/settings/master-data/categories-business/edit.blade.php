...
@section('content')
<form id="form-post" class="nk-content-inner" action="{{ route('system.settings.master-data.tm-categories-business.update',['tm_categories_business'=>$c_business->id]) }}" method="post">
@csrf
@method('PUT')
        ...
        <div class="nk-block-head-content">
            ...
            <div class="nk-block-des text-soft text-sm">
                <ul class="list-inline">
                    <li class="text-muted">
                        <small>ID: <span class="font-weight-bold">{{$c_business->id}}</span></small>
                        <input type="hidden" name="id" value="40">
                    </li>
                    <li class="text-muted">
                        <small>Last Update: <span class="font-weight-bold">{{$c_business->updated_at}}</span></small>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card-inner">
            ...
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="input-title" value="{{$c_business->title ?? null}}" name="title">
                        </div>
                    </div>
                </div>
            </div>
