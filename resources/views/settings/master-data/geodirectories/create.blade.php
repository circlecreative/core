...
@section('content')
<form id="form-post" class="nk-content-inner" action="{{ route('system.settings.master-data.tm-geodirectories.store') }}" method="post">
@csrf
        ...
        <div class="card-inner">
                    ...
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <select class="form-select" name="type">
                                <option value="CONTINENT">@lang('lang.continent')</option>
                                <option value="SUBCONTINENT">@lang('lang.subcontinent')</option>
                                <option value="COUNTRY">@lang('lang.country')</option>
                                <option value="STATE">@lang('lang.state')</option>
                                <option value="PROVINCE">@lang('lang.province')</option>
                                <option value="CITY">@lang('lang.city')</option>
                                <option value="DISTRICT">@lang('lang.district')</option>
                                <option value="SUBDISTRICT">@lang('lang.subdistrict')</option>
                                <option value="VILLAGE">@lang('lang.village')</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-3 align-center">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="number" class="form-control w-25" id="input-code" value="" name="code">
                        </div>
                    </div>
                </div>
            </div>
