...
namespace Neo\Core\Services\Schema\Macros;

use Illuminate\Database\Schema\Blueprint;
use Illuminate\Database\SQLiteConnection;
use Illuminate\Support\Facades\DB;
use Neo\Core\Contracts\MacroInterface;
...
class Macro implements MacroInterface
{
    ...
    private function registerCommonFields()
    {
        Blueprint::macro('commonField', function () {
            $this->registerUserStamps();
            $this->registerSoftUserStamps();
            $this->registerDropUserStamps();
            $this->registerDropSoftUserStamps();
